...
import 'water_reminder_model.dart';
export 'water_reminder_model.dart';

class WaterReminderWidget extends StatefulWidget {
  const WaterReminderWidget({super.key});

  static String routeName = 'water_reminder';
  static String routePath = '/waterReminder';
...
class _WaterReminderWidgetState extends State<WaterReminderWidget> {
  late WaterReminderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WaterReminderModel());
  }
